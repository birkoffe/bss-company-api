...
// Source: github.com/ozonmp/bss-cbssany-api/internal/app/sender (interfaces: EventSender)
...
import (
	...
	model "github.com/ozonmp/bss-cbssany-api/internal/model"
)
...
func (m *MockEventSender) Send(arg0 *model.CompanyEvent) error {
	m.ctrl.T.Helper()
